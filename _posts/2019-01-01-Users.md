...
<p>The user can access can only access the selective checked in and checked out time under the submenu under the ‘in & outs’ submenu in <strong>‘Administration’</strong> category as it is shown below.</p>
